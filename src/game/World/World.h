...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_MAP_OBJECT_THREADS,
    CONFIG_UINT32_MAP_VISIBILITY_CHUNK_SIZE,
    CONFIG_UINT32_MAP_IDLE_BOT_THREADS,
    CONFIG_UINT32_MAP_IDLE_BOT_CHUNK_SIZE,
    CONFIG_UINT32_MAP_IDLE_BOT_MAX_UPDATES_PER_TICK,
    CONFIG_UINT32_MAP_IDLE_BOT_MAX_TIMER_ADVANCE_MS,
    CONFIG_UINT32_MAP_IDLE_BOT_JITTER_MS,
    CONFIG_UINT32_MAP_CELL_THREADS,
    CONFIG_UINT32_MAP_CELL_CHUNK_SIZE,
    CONFIG_UINT32_MAP_CELL_MIN_PARALLEL_CELLS,
    CONFIG_UINT32_MAP_CELL_MAX_CHUNKS_PER_MAP,
    CONFIG_UINT32_MAP_CELL_MAX_WAIT_MS,
    ...
    CONFIG_UINT32_PERFORMANCE_LOG_SLOW_WORLD_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_SLOW_MAP_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_SLOW_BOT_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_SLOW_SESSION_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_SLOW_PACKET_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_SLOW_ASYNC_DB_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_SLOW_DB_CALLBACK_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_SUMMARY_INTERVAL_MS,
    CONFIG_UINT32_PERFORMANCE_LOG_DETAIL_INTERVAL_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_EMPTY_MAP_UPDATE_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_SLOW_WORLD_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_RECOVER_WORLD_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_MIN_VISIBILITY_PERCENT,
    CONFIG_UINT32_ADAPTIVE_LOAD_VISIBILITY_STEP_PERCENT,
    CONFIG_UINT32_ADAPTIVE_LOAD_BOT_BUDGET_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_BACKGROUND_BOT_MIN_UPDATES,
    CONFIG_UINT32_ADAPTIVE_LOAD_BACKGROUND_BOT_MAX_DEFERRAL_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_BOT_RECOVERY_TICKS,
    CONFIG_UINT32_ADAPTIVE_LOAD_MEMORY_SOFT_MB,
    CONFIG_UINT32_ADAPTIVE_LOAD_MEMORY_HARD_MB,
    CONFIG_UINT32_ADAPTIVE_LOAD_MEMORY_RECOVER_MB,
    CONFIG_UINT32_MOVEMENT_COMPRESSION_MIN_PACKETS,
    CONFIG_UINT32_MOVEMENT_BROADCAST_THREADS,
    CONFIG_UINT32_MOVEMENT_BROADCAST_MAX_QUEUED_BATCHES,
    CONFIG_UINT32_DATABASE_CALLBACK_BUDGET_MS,
    CONFIG_UINT32_LOGIN_BOT_SESSIONS_PER_TICK,
    CONFIG_UINT32_PLAYERBOT_IDLE_CORE_UPDATE_SKIP,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_PERFORMANCE_LOG_ENABLED,
    CONFIG_BOOL_PLAYERBOT_STAGGER_BACKGROUND_UPDATES,
    CONFIG_BOOL_ADAPTIVE_LOAD_ENABLED,
    CONFIG_BOOL_MOVEMENT_COMPRESSION_ENABLED,
    CONFIG_BOOL_DYN_RESPAWN_ALLOW_ELITES,
