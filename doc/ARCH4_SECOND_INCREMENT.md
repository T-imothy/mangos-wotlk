...
The 25% whole-process reduction target is not established. Combat/class/instance correctness beyond the native tests and short dev runs remains unverified. Production is unchanged; no Arch 4 push or deployment to production is authorized by this work.
